...
| 3 | `sys_plot_pixel` | `RCX` = x, `RDX` = y | Plots a single green pixel at the given framebuffer coordinates. Internal building block -- mainly called directly by syscall 4, not typically invoked on its own. |
